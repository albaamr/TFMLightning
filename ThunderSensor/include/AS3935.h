...
/**
 * @brief Tunes the AS3935 antenna by measuring resonance frequency on IRQ pin.
 * 
 * @param state Pointer to system state.
 * @param division_factor Frequency division factor for LCO_FDIV (0, 1, 2, 3).
 * @param tune_cap Initial tuning capacitance value (0-15, corresponding to 0-120 pF).
